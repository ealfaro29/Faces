const TIMEZONES = { "America/New_York": "-05:00", "Europe/London": "+00:00" };
...
function convert(tz, y, m, d, hour, minute) {
    ...
    console.log(`Offset: ${offsetString}`);
    console.log(`Parsed: ${dateStr}${offsetString}`);
    console.log(`SJO Result: ${sjoDate} ${sjoTime}`);
}

convert("Australia/Sydney", 2026, 2, 23, 1, 0); // 1 AM Sydney
convert("America/New_York", 2026, 2, 23, 1, 0); // 1 AM NY
